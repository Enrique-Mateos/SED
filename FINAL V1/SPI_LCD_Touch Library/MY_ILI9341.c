...
void ILI9341_printNumber(int n, int16_t x, int16_t y, uint16_t color, uint16_t bg, uint8_t size)
{
	if(n>0 && n<10)
		n=n+48;
	else 
	...
	int16_t offset;
	offset = size*6;
	for(uint16_t i=0; i<40 && n!=NULL; i++)
	{
		ILI9341_drawChar(x+(offset*i), y, n,color,bg,size);
	}
}
